...
export class ProfileComponent implements OnInit {
  ...
  constructor(private httpService: HttpService, private notifyService: NotifyService,public authService: AuthService) {
  ...
  async findUser() {
    ...
    if (response.status == 200) {
      ...
      this.userForm.controls['userId'].setValue(response.data.id);
      this.userForm.controls['firstName'].setValue(response.data.firstName);
      this.userForm.controls['secondName'].setValue(response.data.secondName);
      this.userForm.controls['thirdName'].setValue(response.data.thirdName);
      this.userForm.controls['lastName'].setValue(response.data.lastName);
      this.userForm.controls['username'].setValue(response.data.username);
      this.userForm.controls['email'].setValue(response.data.email);
      this.userForm.controls['mobileNumber'].setValue(response.data.mobileNumber);
