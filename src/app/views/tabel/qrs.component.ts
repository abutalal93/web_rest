...
export class QrsComponent implements OnInit {
  ...
  constructor(private router: Router,private httpService: HttpService, private notifyService: NotifyService, private authService: AuthService) {
  ...
  navigate(qr){
    this.router.navigate(['/order'], { queryParams: {qrId: qr.id}});
  }
